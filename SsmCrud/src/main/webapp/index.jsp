...
<div class="modal fade" id="empUpdateModel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <script type="text/javascript">
        ...
        function build_emps_table(result) {
            ...
            $.each(emps,function (index,item) {
                ...
                var delBtn = $("<button></button>").addClass("btn btn-danger btn-sm delete_btn")
                                            .append($("<span ></span>").addClass("glyphicon glyphicon-tras"))
                                            .append("删除");
        ...
        function build_page_info(result) {
            ...
            $("#page_info_area")
                .append("当前"+result.extend.pageInfo.pageNum+"页,总"+result.extend.pageInfo.pages+"页,共"+result.extend.pageInfo.total+"条");
        ...
        function getDepts(ele) {
            ...
            $.ajax({
                ...
                success:function(ruselt) {
                    // console.log(ruselt);
                    //显示部门信息在下拉列表中
                    $.each(ruselt.extend.depts,function () {
